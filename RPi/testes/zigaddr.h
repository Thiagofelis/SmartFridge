...
#define EADR7 (0x18)
#define RXFLUSH (0x1a)
#define TXSTATE0 (0x1c)
#define TXSTATE1 (0x1e)
#define ORDER (0x20)
#define TXMCR (0x22)
#define ACKTMOUT (0x24)
#define SLALLOC (0x26)
#define SYMTICKL (0x28)
#define SYMTICKH (0x2A)
#define PAONTIME (0x2C)
#define PAONSETUP (0x2E)
#define FFOEN (0x30)
#define CSMACR (0x32)
#define TXBCNTRIG (0x34)
#define TXNMTRIG (0x36)
#define TXG1TRIG (0x38)
#define TXG2TRIG (0x3A)
#define ESLOTG23 (0x3C)
#define ESLOTG45 (0x3E)
#define ESLOTG67 (0x40)
#define TXPEND (0x42)
#define WAKECON (0x44)
#define FRMOFFSET (0x46)
#define TXSR (0x48)
#define TXLERR (0x4A)
#define GATE_CLK (0x4C)
#define TXOFFSET (0x4E)
#define HSYMTMR0 (0x50)
#define HSYMTMR1 (0x52)
#define SOFTRST (0x54)
#define BISTCR (0x56)
#define SECCR0 (0x58)
#define SECCR1 (0x5A)
#define TXPEMISP (0x5C)
#define SECISR (0x5E)
#define RXSR (0x60)
#define ISRSTS (0x62)
#define INTMSK (0x64)
